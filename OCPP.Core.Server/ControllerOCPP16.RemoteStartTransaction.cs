...
namespace OCPP.Core.Server
{
    public partial class ControllerOCPP16
    {
        public void HandleRemoteStartTransaction(OCPPMessage msgIn, OCPPMessage msgOut)
        {
            ...
            try
            {
                RemoteStartTransactionResponse resetResponse = DeserializeMessage<RemoteStartTransactionResponse>(msgIn);
                Logger.LogInformation("RemoteStartTransaction => Answer status: {0}", resetResponse?.Status);
